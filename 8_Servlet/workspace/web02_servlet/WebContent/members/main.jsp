...
<%@page import="edu.bit.members.MemberDAO"%>
       ...
       <tr>
          <td colspan="3" bgcolor="<%=title_c%>"   align="center">
            ...
            <input type="button"  value="회원가입" onclick="javascript:window.location='insertForm.jsp'">
          	<input type="button" value="회원리스트보기" onclick="javascript:window.location='memberList.jsp'">
          </td></form></tr></table>
     <%}else{%>
       <table width=650 cellpadding="0" cellspacing="0"  align="center" border="1" >
         <tr>
           <td width="250" bgcolor="<%=bodyback_c%><input type="button" value="회원리스트보기" onclick="javascript:window.location='memberList.jsp'">" height="20">우리의 메인 하하</td>
